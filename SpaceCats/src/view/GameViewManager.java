...
public class GameViewManager {
    ...
    private final static String BACKGROUND_IMAGE = "view/purple.png";


    private final static String METEOR_BROWN_IMAGE = "view/meteorBrown_med3.png";
    private final static String METEOR_GREY_IMAGE = "view/meteorGrey_med2.png";
    ...
    private void moveGameElements() {
        ...
        for(int i = 0; i < greyMeteors.length; i++) {
            greyMeteors[i].setLayoutY(greyMeteors[i].getLayoutY()+4);
    ...
    private void setNewElementPosition(ImageView image) {
        ...
        image.setLayoutY(-randomPositionGenerator.nextInt(3200)+800);
